...
<html>
    ...
    <script>
        ...
        var val = confirm("¿Desea actualizar su contraseña?");
        if (val == true){
        return true;
        } else{
        return false;
    ...
    <body>
        ...
        <section class="w-70 mx-auto text-center "id='intro'>
            ...
            <p>${men.mensaje}</p>
            <form action="EditPasswordChofer" method="post">
                <div class="mb-3">
                    <input type="hidden" name="ci" value="<%=usuario.getCi()%>">
                    <label>Antigua Contraseña:</label>
                    <input required maxlength="14" minlength="8"type="password" placeholder="Anotar la contraseña que se desea cambiar" name="pass">
                </div>
                <div class="mb-3">
