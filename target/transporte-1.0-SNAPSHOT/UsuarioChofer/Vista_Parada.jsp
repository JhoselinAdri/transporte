...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-danger" aria-current="page" href="ParadaController">Paradas</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="w-100 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold">Hojas de Ruta del Totales</h2>
            
            <h2 class="text-info fw-bold">RUTAS</h2>
            <input type="text" id="filtro" onkeyup="filtrarTabla()" placeholder="Fecha">
            <table class="table table-striped border-0" id="tabla">
                ...
                <c:forEach var="item" items="${ruta}">
                    <tr>
                        <td data_titulo="#">
                            ${item.n_ruta}
                        </td> 
                        <td data_titulo="Registrador:">
                            ${item.ci_chofer}
                        </td>
                        <td data_titulo="Fecha:">
                            ${item.fecha}
                        </td>                                    
                        <td data_titulo="Linea">
                            ${item.linea}
                        </td>
                        <td>
                            <a href="ParadaDetalleController?n=${item.n_ruta}&ci=${item.ci_chofer}&linea=${item.linea}" class="drop-cart">
