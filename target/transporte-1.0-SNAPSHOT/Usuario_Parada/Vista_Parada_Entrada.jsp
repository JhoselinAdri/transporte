...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-danger" aria-current="page" href="PEntradaController">Entrada</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="w-100 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold">Nuevos Registros</h2>
            <p>${mensaje.mensaje}</p>
            <form action="NuevoController" method="POST">
            ...
            <form name="buscar"  action="PEntradaController" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control-lg border-0 text-center"required  type="text" name="observacion"" >    
                </div>  
                <input  class="btn btn-secondary btn-sm rounded-0" id="inputGroupPrepend2" type="submit" value="Registrar Llegada">
            </form>
