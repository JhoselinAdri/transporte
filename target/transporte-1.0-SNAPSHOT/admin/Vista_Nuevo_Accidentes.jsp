...
<html>
    ...
    <body>
        ...
        <section class="w-70 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold" >Registro Personal Accidentes</h2>
            <p class="fw-bold">El usuario por defecto sera el PrimerNombre_CI </p>
            <p class="fw-bold">La contraseña por defecto sera CI </p>
            <form action="AdminNuevoAccidentes" method="post" onsubmit="return validarFecha();" class="row g-3">
               ...
               <div class="col-md-4">
                    ...
                    <input type="text" placeholder="Direccion" name="direccion" class="form-control is-valid" id="validationServer01"  required maxlength="50" minlength="5">
                </div>
