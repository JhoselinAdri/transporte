    ...
    <body>
        ...
        <section class="w-70 mx-auto text-center "id='intro'>
            ...
            <form>
                <div class="mb-3">
                    <label>Nombre:</label>
                    <input class="form-control-lg border-0" readonly type="text" placeholder="nombre" value="<%=usuario.getNombre()%> <%=usuario.getApm()%> <%=usuario.getApm()%>">
                </div>
                <div class="mb-3">
                    <label>CI:</label>
                    <input class="form-control-lg border-0"readonly type="Number" placeholder="usu" value="<%=usuario.getCi()%>">    
                </div>  
                <div class="mb-3">
                    <label>N°Celular:</label>
                    <input class="form-control-lg border-0"readonly type="Number" placeholder="num-cel" value="<%=usuario.getCelular()%>"> 
                </div> 
                <div class="mb-3">    
                    <label>Dirección</label>
                    <input class="form-control-lg border-0"readonly type="text" placeholder="cat" maxlength="1" value="<%=usuario.getDireccion()%>"> 
                </div>
            </form>
            <a href="EditPasswordAdmin?ci=<%=usuario.getCi()%>"><input  class="btn btn-secondary btn-sm rounded-0" id="inputGroupPrepend2" type="submit" value="Editar Contraseña"></a>
        </section>
