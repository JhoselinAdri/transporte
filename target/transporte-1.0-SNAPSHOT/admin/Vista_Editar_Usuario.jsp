...
<html>
    ...
    <body>
        ...
        <a href="Rest_pass?ci=${datos.ci}" class="btn btn-danger"  >Restablecer Contraseña</a>
        <section class="w-70 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold" >Registro Conductor</h2>

            <form action="AdminEditUsuario" method="post" onsubmit="return validarFecha();" class="row g-3">
                <h3 class="text-info fw-bold">Datos Licencia</h3>
                <div class="col-md-4">

                    <label for="validationServer01" class="form-label">Numero de Licencia:</label>
                    <input value="${datos.licencia_id}"required readonly type="number" class="form-control is-valid" id="validationServer01" placeholder="Numero Licencia"  maxlength="7" minlength="8" name="licencia" max="99999999" min="1000000">
                ...
                <div class="col-md-4">
                    ...
                    <input value="${datos.fecha_exp}"required type="date" id="fecha" name="fecha" class="form-control is-valid" id="validationServer01" placeholder="Fecha Expiración" required>
                </div> 
                ...
                <div class="col-md-4">
                    ...
                    <input value="${datos.n_celular}"required type="Number" placeholder="Celular" name="celular" class="form-control is-valid" id="validationServer01"  required maxlength="8" minlength="8"max="79999999" min="60000000"> 
                </div> 
                <div class="col-md-4">    
                ...
                <div class="col-md-4">    
                    ...
                    <input value="${datos.placa}"required readonly type="text" placeholder="placa" name="placa" class="form-control is-valid" id="validationServer01"  required maxlength="8" minlength="8"> 

                </div> 
                <div class="col-md-4">    
                    <label for="validationServer01" class="form-label">Modelo:</label>
                    <input value="${datos.modelo}"required type="number" placeholder="Modelo" name="modelo" class="form-control is-valid" id="validationServer01"  required maxlength="25" minlength="5"max="2020" min="1970"> 

                </div> 
                <div class="col-md-4">    
                    <label for="validationServer01" class="form-label">Marca:</label>
                    <input value="${datos.marca}"required type="text" placeholder="Marca" name="marca" class="form-control is-valid" id="validationServer01"  required maxlength="10" minlength="3"> 

                </div> <div class="col-md-4">    
                    <label for="validationServer01" class="form-label">Tipo:</label>
                    <input value="${datos.tipo}"required type="text" placeholder="Tipo" name="tipo" class="form-control is-valid" id="validationServer01"  required maxlength="10" minlength="3"> 

                </div> 
                <div class="col-md-4">    
                    <label for="validationServer01" class="form-label">Estado:</label>
                    <input value="${datos.estado}"required type="text" placeholder="Estado" name="estado" class="form-control is-valid" id="validationServer01"  required maxlength="10" minlength="3"> 

                </div> 
                <div class="col-md-4">    
                    <label for="validationServer01" class="form-label">Cantidad de asientos:</label>
                    <input value="${datos.capacidad}"required type="number" placeholder="Cantidad de asientos" name="capacidad" class="form-control is-valid" id="validationServer01"  required maxlength="3" minlength="2"max="45" min="20"> 
