...
<% List<Avisos> comunicados = (List<Avisos>) request.getAttribute("comunicados");%>
<%@page import="java.util.Base64"%>
<%@page import="com.grupo.modelo.Avisos"%>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light p-3"  id="menu">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="LoginController"">Chofer</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="LoginParada">Control de Paradas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"  href="LoginAportes">Control Aportes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="AccidentesLoginController">Control de Accidentes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="AdministradorLoginController">Administracion</a>
                        </li>
