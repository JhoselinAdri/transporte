...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-danger" aria-current="page" href="TodosRegistrosController">Registro</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="w-100 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold">Lista Notificaciones</h2>
            <input type="text" id="filtro" onkeyup="filtrarTabla()" placeholder="CI:">
            <table class="table table-striped border-0" id="tabla">
                ...
                <c:forEach var="item" items="${ruta}">
                    ...
                    <td>
                        <a href="PDetalleController?n=${item.n_ruta}&ci=${item.ci_chofer}&linea=${item.linea}" class="drop-cart">
