...
<html>
    ...
    <body>
        ...
        <section class="w-50 mx-auto text-center "id='intro'>
            ...
            <h2 class="text-info fw-bold">Editar Comunicado</h2>
            <form class="row g-3" action="SubirImagenEdit" method="post" enctype="multipart/form-data" accept-charset="UTF-8"> 
                <label>Nombre del archivo:</label>
                <input readonly type="text" name="nombre" value="${com.nombre}">
                <label>Numero de Aviso</label>
                <input readonly type="text" name="n" value="${com.n}">
                ...
                <div class="form-group text-center">
                    <button class="btn btn-success"name="action" value="add"> Editar Comunicado</button>
                </div> 
