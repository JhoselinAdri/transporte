...
<html>
    ...
    <body>
        ...
        <a href="Rest_passAcc?ci=${datos.ci}" class="btn btn-danger"  >Restablecer Contraseña</a>
        <section class="w-70 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold" >Registro personal Accidentes</h2>

            <form action="AdminEditAccidente" method="post" onsubmit="return validarFecha();" class="row g-3">
                ...
                <div class="col-md-4">    
                    ...
                    <input value="${datos.direccion}"required type="text" placeholder="Username" name="direccion" class="form-control is-valid" id="validationServer01"  required maxlength="50" minlength="5"> 
                </div> 
