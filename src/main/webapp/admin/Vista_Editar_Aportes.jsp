...
<html>
    ...
    <body>
        ...
        <a href="Rest_passAp?ci=${datos.ci}" class="btn btn-danger"  >Restablecer Contraseña</a>
        <section class="w-70 mx-auto text-center "id='intro'>
            <h2 class="text-info fw-bold" >Registro personal Aportes</h2>

            <form action="AdminEditAp" method="post" onsubmit="return validarFecha();" class="row g-3">
