...
import com.grupo.controlador.parada.*;
...
@WebServlet(name = "ParadaDetalleController", urlPatterns = {"/ParadaDetalleController"})
public class ParadaDetalleController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("UsuarioChofer/Vista_Det_Ruta.jsp").forward(request, response);
    }
