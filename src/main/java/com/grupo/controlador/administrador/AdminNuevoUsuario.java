...
@WebServlet(name = "AdminNuevoUsuario", urlPatterns = {"/AdminNuevoUsuario"})
public class AdminNuevoUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin/Vista_Nuevo_Usuario.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            dao.insertUsuario(ch, lice, ve);
        } catch (Exception ex) {
            System.out.println("Error en el dao chofer" + ex);
        }
