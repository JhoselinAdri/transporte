...
@WebServlet(name = "AdminDetalleAporte", urlPatterns = {"/AdminDetalleAporte"})
public class AdminDetalleAporte extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Control_aportes ch= new Control_aportes();
        switch (action) {
            case "edit":
